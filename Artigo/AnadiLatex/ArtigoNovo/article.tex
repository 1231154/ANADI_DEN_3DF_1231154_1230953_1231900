...
PTD  & Distribution Transformer Substation \\
...
\subsubsection{Artificial Neural Network (MLP Regressor)}
...
\subsubsection{Artificial Neural Network (MLP Classifier)}
...
GridSearchCV for the Decision Tree explored only \texttt{max\_depth} and \texttt{min\_samples\_leaf}; additional parameters such as \texttt{criterion} (Gini vs. entropy) and \texttt{max\_features} were not tuned. ANN architecture selection was limited to three manually defined configurations.
...
\begin{itemize}
  ...
  \item \textbf{Feature engineering and selection:} Applying SHAP values or Recursive Feature Elimination (RFE) to identify and discard low-contribution features could reduce noise and improve generalization. Interaction terms between \texttt{Cap\_PTD\_kVA} and lighting variables may expose synergies not captured by linear correlations.
...
\bibitem{ANNBigData2024}
``ANN models for forecasting tasks,'' \textit{Journal of Big Data}, 2024.
...
\bibitem{SVMModels2024}
``SVM Hyperplane Separation Models,'' \textit{Emerging Science Journal}, 2024.

\bibitem{ANNModels2024}
``ANN Architecture and Models,'' \textit{Emerging Science Journal}, 2024.

\bibitem{DTXGBModels2024}
``Decision Tree and XGBoost Architectures,'' \textit{Emerging Science Journal}, 2024.

\bibitem{Altmann2010}
A. Altmann, L. Tolo\c{s}i, O. Sander, and T. Lengauer, ``A comparative study on breast cancer classification with stratified shuffle split and K-fold cross validation via ensembled machine learning,'' \textit{ScienceDirect}, 2010.

\bibitem{Malakouti2023}
S. M. Malakouti, ``The usage of 10-fold cross-validation and grid search to enhance ML methods performance in solar farm power generation prediction,'' \textit{ScienceDirect}, 2023.
...
\bibitem{SystematicReviewAI2025}
``Systematic Review of AI in Fault Detection,'' \textit{IEEE Xplore/ScienceDirect}, 2025.

\bibitem{Badhon2024}
N. H. Badhon et al., ``TLCNN: Tabular data-based lightweight convolutional neural network for electricity energy demand prediction,'' \textit{ScienceDirect}, 2024.
...
\bibitem{Calero2020}
I. Calero et al., ``Machine Learning-Based Control of Electric Vehicle Charging for Practical Distribution Systems with Solar Generation,'' \textit{IEEE}, 2020.

\bibitem{Hines2011}
P. Hines et al., ``Estimating the Impact of Electric Vehicle Smart Charging on Distribution Transformer Aging,'' \textit{IEEE}, 2011.
...
\bibitem{DTU2022}
``Transformer overload prediction in a future energy system: The impact of increasing EV charging demand,'' DTU, 2022.

\bibitem{ARIMA2023}
``ARIMA-GRU approaches,'' \textit{Sustainability}, 2023.

\bibitem{Elkari2023}
B. Elkari et al., ``Random forest with feature selection and K-fold cross validation for predicting the electrical and thermal efficiencies of air based photovoltaic-thermal systems,'' \textit{ScienceDirect}, 2023.
...
\bibitem{MTR2022a}
M. T. R. et al., ``An Efficient Ensemble Method Using K-Fold Cross Validation for the Early Detection of Benign and Malignant Breast Cancer,'' \textit{IJIE}, vol. 14, 2022.

\bibitem{KNN2023}
``KNN Classification Report,'' \textit{Journal of Environmental and Agricultural Studies}, 2023.

\bibitem{PrecisionRecall2022}
``Precision-Recall AUC scores for ML classifiers,'' \textit{Frontiers in Nanotechnology}, 2022.

\bibitem{CrossValidation2000}
``Cross-Validation Methods,'' \textit{Journal of Mathematical Psychology}, 2000.

\bibitem{MTR2022b}
M. T. R. et al., ``AdaBoost Ensemble Methods Using K-Fold Cross Validation,'' \textit{Computational Intelligence and Neuroscience}, 2022.

\bibitem{Ranjan2019}
G. S. K. Ranjan et al., ``K-Nearest Neighbors and Grid Search CV Based Real Time Fault Monitoring System for Industries,'' \textit{IEEE}, 2019.
...
\bibitem{IRTestStats2007}
``Information Retrieval Test Statistics,'' \textit{ACM Press}, 2007.
